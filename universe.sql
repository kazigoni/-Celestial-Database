...
ALTER SEQUENCE public.galaxy_types_galaxy_type_id_seq OWNED BY public.galaxytype.galaxytype_id;
...
ALTER TABLE ONLY public.galaxytype ALTER COLUMN galaxytype_id SET DEFAULT nextval('public.galaxy_types_galaxy_type_id_seq'::regclass);
...
INSERT INTO public.galaxytype VALUES (1, 'Spiral', 'Characterized by a central bulge surrounded by a disk of stars, gas and dust in a spiral structure');
INSERT INTO public.galaxytype VALUES (2, 'Elliptical', 'Characterized by smooth, featureless light distribution and appear as ellipses in images');
INSERT INTO public.galaxytype VALUES (3, 'Irregular', 'Galaxy that does not have a distinct regular shape');
INSERT INTO public.galaxytype VALUES (4, 'Lenticular', 'Intermediate between spiral and elliptical galaxies');
...
INSERT INTO public.planettypes VALUES (1, 'Terrestrial', 'Rocky planets like Earth');
INSERT INTO public.planettypes VALUES (2, 'Gas Giant', 'Large planets primarily composed of hydrogen and helium');
INSERT INTO public.planettypes VALUES (3, 'Ice Giant', 'Planets mainly composed of ices, rocks and gases');
INSERT INTO public.planettypes VALUES (4, 'Super Earth', 'Rocky planets larger than Earth but smaller than gas giants');
...
--
-- Name: galaxytype galaxy_types_name_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: galaxytype galaxy_types_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.galaxytype
    ADD CONSTRAINT galaxy_types_pkey PRIMARY KEY (galaxytype_id);
...
ALTER TABLE ONLY public.galaxy
    ADD CONSTRAINT galaxy_galaxy_type_id_fkey FOREIGN KEY (galaxytype_id) REFERENCES public.galaxytype(galaxytype_id);
...
ALTER TABLE ONLY public.planet
    ADD CONSTRAINT planet_planet_type_id_fkey FOREIGN KEY (planettypes_id) REFERENCES public.planettypes(planettypes_id);
